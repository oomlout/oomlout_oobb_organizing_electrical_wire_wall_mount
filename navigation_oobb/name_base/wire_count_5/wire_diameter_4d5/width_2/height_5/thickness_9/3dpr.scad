			...
			rotate(a = [180, 0, 0]) {
				difference() {
					...
					union() {
						...
						translate(v = [0, 30.0000000000, 4.5000000000]) {
							rotate(a = [0, 0, 0]) {
								difference() {
									union() {
						...
						translate(v = [-7.5000000000, -30.0000000000, 4.5000000000]) {
						...
						translate(v = [-50.0000000000, -15.0000000000, 4.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 100, r = 2.2500000000);
							}
						}
						translate(v = [-50.0000000000, -7.5000000000, 4.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 100, r = 2.2500000000);
							}
						}
						translate(v = [-50.0000000000, 0.0000000000, 4.5000000000]) {
							rotate(a = [0, 90, 0]) {
								cylinder(h = 100, r = 2.2500000000);
							}
						}
