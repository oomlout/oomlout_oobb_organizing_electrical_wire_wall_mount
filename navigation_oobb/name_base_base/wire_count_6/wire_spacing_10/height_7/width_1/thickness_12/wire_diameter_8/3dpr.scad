		...
		translate(v = [50, 0, 12]) {
			rotate(a = [180, 0, 0]) {
				difference() {
					...
					union() {
						translate(v = [0, 37.5000000000, 12]) {
							rotate(a = [0, 0, 0]) {
								difference() {
									union() {
						...
						translate(v = [0, 45.0000000000, 6.0000000000]) {
							rotate(a = [0, 0, 0]) {
								difference() {
									union() {
						...
						translate(v = [0.0000000000, -45.0000000000, 6.0000000000]) {
						...
						translate(v = [-50.0000000000, -25.0000000000, 6.0000000000]) {
							rotate(a = [0, 90, 0]) {
